  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (crearCuenta) {
        ...
        // Cerrar sesión del usuario recién creado (por seguridad)
            ...
            <label className="flex items-start gap-3 cursor-pointer mb-4">
              ...
              <div className="flex-1">
                <div className="font-bold text-slate-800 flex items-center gap-2">
                  👷 Crear también cuenta de Supervisor
                </div>
                <p className="text-xs text-slate-600 mt-1">
                  Al activar esta opción, se creará una cuenta de inicio de sesión para que este empleado pueda acceder al Portal de Supervisores.
                </p>
              </div>
            </label>
            ...
            {crearCuenta && (
              <div className="bg-white rounded-xl p-4 border border-blue-200 space-y-3">
                ...
                <div>
                  ...
                  <input
                    type="email"
                    value={cuentaSupervisor.correo}
                    onChange={(e) => setCuentaSupervisor(prev => ({ ...prev, correo: e.target.value }))}
                    className="w-full border border-slate-300 rounded-lg p-2.5 outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                  ...
                  <input
                    type="password"
                    value={cuentaSupervisor.password}
                    onChange={(e) => setCuentaSupervisor(prev => ({ ...prev, password: e.target.value }))}
                    className="w-full border border-slate-300 rounded-lg p-2.5 outline-none focus:ring-2 focus:ring-blue-500"
